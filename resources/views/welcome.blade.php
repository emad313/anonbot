...
.chatbox-msgarea .user{
    overflow: hidden;
    display: flex;
    flex-direction: row-reverse;
}
.chatbox-msgarea .bot .msg {
    padding: 10px 26px;
            ...
            <div class="chatbox" >
                ...
                <div class="chatbox-inputarea">
                    <div class="chatbox-input">
                        <input type="text" placeholder="Send your Messages..." name="" id="">
